...
export const PRESETS: Preset[] = [
  {
    ...
    config: {
      ...
      color: '#ffffff',
      bold: true,
      background: { type: 'solid', color: '#e63946' },
    },
  },
  {
    name: '新品上市',
  ...
  },
  {
    ...
    config: {
      ...
      speed: 1,
      color: '#3d2c2c',
      background: { type: 'solid', color: '#ffd6a5' },
    },
  },
  {
    name: '关注我',
  ...
  },
  {
    ...
    config: {
      ...
      speed: 1,
      color: '#ffd700',
      background: { type: 'solid', color: '#2d1b3d' },
    },
  },
  {
    name: '纯文字封面',
...
interface ConfigStore extends ConfigState {
  // In-memory only; never persisted to history/localStorage.
