...
const API_BASE = 'https://wh001-d0gpvirgcdeafc90c.service.tcloudbase.com';
...
export default function WatermarkRemoverPage() {
  ...
  async function handleRemoveWatermark() {
    ...
    try {
      const resp = await fetch(`${API_BASE}/remove-watermark`, {
        method: 'POST',
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
        上传图片，通过 AI 多模态模型智能去除水印文字和 Logo。图片不会被保存，处理后即可下载。
      </p>
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 min-h-[120px] flex items-center justify-center">
                {result ? (
                  ...
                  <div className="text-center py-10">
                    ...
                    <p className="text-sm text-gray-400">AI 正在处理…</p>
                  </div>
                ) : (
      ...
      {/* Need AI pack hint */}
      <div className="mt-6 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 text-xs border border-amber-200 dark:border-amber-800">
        💡 去水印功能依赖 CloudBase Token Credits 资源包。如未购买，AI 调用会失败。
        <a
          href="https://buy.cloud.tencent.com/lowcode?buyType=resPack&envId=wh001-d0gpvirgcdeafc90c&resourceType=token"
          target="_blank"
